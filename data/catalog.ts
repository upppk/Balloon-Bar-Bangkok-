...
const babyBluePrices: Record<number, number> = {
  1: 2115, 2: 4240, 3: 2775, 4: 4270, 5: 3070, 6: 2290, 7: 1960, 8: 1940,
  9: 2010, 10: 2390, 11: 2760, 12: 2145, 13: 1975, 14: 2490, 15: 2170,
  16: 3120, 17: 935, 18: 3260, 19: 3280, 20: 4360, 21: 1650, 22: 2480,
  23: 1585, 24: 5130, 25: 2980, 26: 2510, 27: 5220, 28: 2115, 29: 2510,
  30: 5780, 31: 3890, 32: 2800, 33: 2100, 34: 2515, 35: 2150, 36: 2615,
  37: 2235, 38: 2650,
};
...
const babyPinkPrices: Record<number, number> = {
  ...
  37: 1410, 38: 2715, 39: 3140, 40: 3800, 41: 1410, 42: 1790, 43: 1575,
};
...
const roseGoldPrices: Record<number, number> = {
  1: 2980, 9: 2930, 17: 2890, 25: 1650, 33: 1600, 41: 790, 45: 1745,
  49: 3545, 57: 2930, 65: 2410, 73: 1685, 81: 850, 89: 3200, 97: 1610,
  105: 3140, 113: 2320, 116: 1295,
};

// ราคาที่คัดสรร (17 จาก 141 รูป) — รูปที่เหลือยังไม่มีราคา รอเพิ่มทีหลังได้
const pinkPrices: Record<number, number> = {
  1: 4185, 9: 1900, 17: 3005, 25: 2355, 33: 2200, 41: 1395, 49: 2420,
  57: 2930, 65: 2730, 73: 3370, 81: 1950, 89: 3125, 97: 1380, 105: 1950,
  113: 1790, 125: 2590, 141: 1410,
};

// ราคาที่คัดสรร (16 จาก 93 รูป) — รูปที่เหลือยังไม่มีราคา รอเพิ่มทีหลังได้
const redPrices: Record<number, number> = {
  1: 3380, 7: 1855, 13: 1830, 19: 1730, 25: 3090, 31: 2180, 37: 4360,
  43: 2400, 49: 3400, 55: 1215, 61: 2260, 67: 1410, 73: 1980, 79: 1170,
  85: 535, 93: 1405,
};

// ราคาที่คัดสรร (15 จาก 47 รูป) — รูปที่เหลือยังไม่มีราคา รอเพิ่มทีหลังได้
const greenPrices: Record<number, number> = {
  1: 2730, 4: 3015, 7: 1990, 10: 3860, 13: 3540, 16: 6280, 19: 3890,
  22: 1005, 25: 3540, 28: 2390, 31: 1775, 37: 1990, 40: 1745, 43: 1495, 47: 1900,
};

// ราคาที่คัดสรร (9 จาก 17 รูป) — รูปที่เหลือยังไม่มีราคา รอเพิ่มทีหลังได้
const yellowOrangePrices: Record<number, number> = {
  1: 1675, 3: 3030, 5: 1665, 7: 1065, 9: 3030, 11: 1120, 13: 4115, 15: 1845, 17: 1715,
};
...
const whitesandPrices: Record<number, number> = {
  1: 2860, 6: 3080, 11: 3660, 17: 1995, 23: 1665, 29: 3560, 36: 435, 40: 2590, 42: 1000,
};
...
const cartoonPrices: Record<number, number> = {
  1: 1375, 25: 1370, 50: 3705, 75: 3640, 100: 1140, 125: 2620, 150: 1085, 175: 5190, 196: 4405,
};

// ราคาที่คัดสรร (9 จาก 236 รูป) — รูปที่เหลือยังไม่มีราคา รอเพิ่มทีหลังได้
const numberalphabetPrices: Record<number, number> = {
  1: 1770, 30: 4210, 60: 2090, 90: 1760, 120: 2755, 150: 2710, 180: 2450, 210: 3305, 236: 310,
};
...
const bridetobePrices: Record<number, number> = {
  1: 3280, 10: 3140, 20: 2930, 30: 2800, 40: 2660, 50: 1270, 60: 3420, 70: 3610, 74: 1615,
};
