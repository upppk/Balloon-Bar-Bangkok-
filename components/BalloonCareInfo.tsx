  ...
  const sizePricing = [
    ...
    },
    {
      ...
      items: [
        ...
        { nameEn: 'Aqua 24" + Glitter + Message', nameTh: "อควาใส่กลิตเตอร์ — ลูกโป่งใสใส่กลิตเตอร์", priceEn: "1,290 THB", priceTh: "1,290 บาท", image: "/images/products/size-pricing/24in_glitter-orbz.png" },
        { nameEn: 'Aqua 24" + Feather + Message', nameTh: "อควาใส่ขนนก — ลูกโป่งใสใส่ขนนก", priceEn: "1,490 THB", priceTh: "1,490 บาท", image: "/images/products/size-pricing/24in_feather-orbz.png" },
        { nameEn: 'Latex Balloon 24"', nameTh: "ลูกโป่งสีพื้น — ลูกยางธรรมดา", priceEn: "Plain 1,090 / Chrome 1,290 THB", priceTh: "สีพื้น 1,090 / สีโครม 1,290 บาท", image: "/images/products/size-pricing/24in_plain-latex.png" },
        { nameEn: 'Aqua 24" Over Latex Balloon (2 Layers)', nameTh: "อควาซ้อนลูกยาง — ลูกยางซ้อนลูกใส 2 ชั้น", priceEn: "Plain 1,390 / Chrome 1,590 THB", priceTh: "ลูกยางสีพื้น 1,390 / ลูกยางสีโครม 1,590 บาท", image: "/images/products/size-pricing/24in_layered-orbz.png" },
        { nameEn: 'Aqua 24" + Glitter Over Latex Balloon (2 Layers, Glitter Between)', nameTh: "อควาซ้อนลูกยางใส่กลิตเตอร์ — ลูกโป่ง 2 ชั้น ใส่กลิตเตอร์ระหว่างชั้น", priceEn: "Plain 1,490 / Chrome 1,690 THB", priceTh: "ลูกยางสีพื้น 1,490 / ลูกยางสีโครม 1,690 บาท", image: "/images/products/size-pricing/24in_layered-glitter-orbz.png" },
        { nameEn: 'Special Collection - Aqua 24" + Acrylic Paint + Message', nameTh: "อควาเพ้นสีอคริลิค — ลูกโป่งใสเพ้นสี", priceEn: "1,390 THB", priceTh: "1,390 บาท", image: "/images/products/size-pricing/24in_acrylic-paint.png" },
        { nameEn: 'Special Collection - Aqua 24" + Gems + Message', nameTh: "อควาติดเพชร — ลูกโป่งใสติดเพชร", priceEn: "1,390 THB", priceTh: "1,390 บาท", image: "/images/products/size-pricing/24in_gem-orbz.png" },
        { nameEn: 'Special Collection - Plain Latex 24" + Butterfly Decoration + Message', nameTh: "ลูกยางสีพื้นติดผีเสื้อ — ลูกยางสีพื้น ติดลายผีเสื้อ", priceEn: '18" 1,390 / 24" 1,490 THB', priceTh: 'ขนาด 18" 1,390 / ขนาด 24" 1,490 บาท', image: "/images/products/size-pricing/24in_butterfly-latex.png" },
      ],
      notesEn: [],
      notesTh: [],
    },
